...
// IssueType::epic because this is a Epic class.
...
// method prints the epic, using a red icon, to the console.
// 6. Friendship - The private statusToString method is a friend function of
// the Issue class so that it can be accessed within the Epic class despite
// being private.
...
// called without an instance of the Epic class.
void Epic::print() {
